...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px">
	<form id="form1" action="${pageContext.request.contextPath}/admin/blogger/save.do" method="post" enctype="multipart/form-data">
	 	<table cellspacing="20px">
	   		...
	   		<tr>
	   			<td>个人头像：</td>
	   			<td><input type="file" id="imageFile" name="imageFile" style="width: 200px;"/>
	   				<span style="color:red">
		   				<c:choose>
		   					<c:when test="${currentUser.imageName == null }">
		   						博主未上传头像
		   					</c:when>
		   					<c:otherwise>
		   						博主头像&nbsp;${currentUser.imageName }
		   					</c:otherwise>
		   				</c:choose>
	   				</span>
	   			</td>
