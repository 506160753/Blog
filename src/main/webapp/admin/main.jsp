	...
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				...
				--%>
				<span style="padding-top:5px;padding-left:5px;font-size:40px;color:red">后台丑点没关系</span>		
			</td>
			<td valign="bottom" align="right" width="50%">
				<font size="3">&nbsp;&nbsp;<strong>欢迎博主：</strong>${currentUser.userName }<strong>管理博客</strong></font>
			</td>
		</tr>
	</table>
</div>
